...
function App() {
  ...
  return (
    <>
      <div className='w-full max-w-none min-h-screen h-screen bg-home touch-none flex flex-col overflow-hidden'>
        <Navbar />
        ...
        <p className='tp-6 md:tp-5 !leading-[1] !tracking-[0.15em] md:!tracking-[4px] !font-["Barlow_Condensed"] text-[#D0D6F9] '>SO, YOU WANT TO TRAVEL TO</p>
